...
|<nobr>`-ClearIndex`</nobr>|Clear the index and force LUnit to rediscover all tests. Default is True. The index must be cleared to find new tests inherited for a Test Case. Set to false to speed up execution of large projects.|
